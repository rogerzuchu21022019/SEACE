...
class StoriesInHomeScreenSeaceAdapter :
    RecyclerView.Adapter<StoriesInHomeScreenSeaceAdapter.HistoryViewHolder>() {
    private var listStories: List<StoryItem> = emptyList()
    private var listUsers: List<UserItem> = emptyList()
    lateinit var layoutInflater: LayoutInflater
    lateinit var itemRvStoriesBinding: ItemRvStorySeaceBinding

    class HistoryViewHolder(itemRvStoriesBinding: ItemRvStorySeaceBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HistoryViewHolder {
        ...
        itemRvStoriesBinding = ItemRvStorySeaceBinding.inflate(layoutInflater, parent, false)
